                ...
                <div className="text-lg flex flex-col justify-center">
                    ...
                    <FadeIn transitionDuration={600} delay={700}>
                        <div className="p-5 lg:pl-0 prose lg:prose-xl text-white text-justify flex justify-center self-center">
                            <p>
                                I am a recent graduate from <span style={{fontWeight:'bold'}}>Simon Fraser University</span>. 
                                I am currently working at{" "} 
                                <a href="https://www.rainforestautomation.com/" style={{color:"#15cdfc", fontWeight:'bold', textDecoration:'none'}} target="_blank" rel="noreferrer">Rainforest Automation</a> 
                                ...
                                a side project using React, Sanity.io, tailwindCSS, and Netlify. <br/><br/>
