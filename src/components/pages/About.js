					...
					<FadeIn transitionDuration={600} delay={700}>
						<div className="p-5 lg:pl-0 prose lg:prose-xl text-white text-justify flex justify-center self-center">
							<p>
								...
								<a
									href="https://www.rainforestautomation.com/"
									style={{
										color: "#15cdfc",
										fontWeight: "bold",
										textDecoration: "none",
								...
								as a{" "}
								<span style={{ color: "#15cdfc", fontWeight: "bold" }}>
									Software Developer
								</span>
								. I am always excited to learn new technologies and take on
								challenges in this evolving industry. <br />
								<br />
								My main focus these days is{" "}
								<span style={{ color: "#15cdfc", fontWeight: "bold" }}>
									building scalable applications{" "}
								</span>
								that allows users to have a great experience with ease to
								navigate and use all the features. <br />
								<br />I have recently{" "}
								<span style={{ color: "#15cdfc", fontWeight: "bold" }}>
									built and launched my personal portfolio
								</span>{" "}
								as a side project using React, Sanity.io, tailwindCSS, and
								Netlify. <br />
								<br />
